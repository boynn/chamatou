...
public class AppConfig{
	...
	public final static String TEMP_TWEET = "temp_goods";
	public final static String TEMP_TWEET_IMAGE = "temp_goods_image";
	...
	public final static String CONF_INFO_PWD = "info_password";
