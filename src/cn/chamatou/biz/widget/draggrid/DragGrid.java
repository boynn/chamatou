package cn.chamatou.biz.widget.draggrid;
...
public class DragGrid extends GridView {
	...
	public void init(Context context) {
		...
		// 将布局文件中设置的间距dip转为px
		mHorizontalSpacing = UiTool.dip2px(context, mHorizontalSpacing);
	}
...
//				}
	...
	public void startDrag(Bitmap dragBitmap, int x, int y) {
		...
		this.windowParams.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE | WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON | WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN;
