...
public class Update implements Serializable{
	...
	public final static String NODE_ROOT = "bbmb";
	...
	public static Update parse(String json) throws IOException, AppException {
		Update update = null;
        //获得XmlPullParser解析器
        XmlPullParser xmlParser = Xml.newPullParser();
        try {        	
        	InputStream xml=new ByteArrayInputStream(json.getBytes());
        	xmlParser.setInput(xml, UTF8);
